...
(define-listener registry-listener
  (global ((registry :pointer) (id :uint32) (interface :string) (version :uint32))
    ...
    (cond ((string= interface "wl_compositor")
           (setf (compositor window) (wl:registry-bind registry id (cffi:get-var-pointer 'wl:compositor-interface) (min version 3))))
          ...
          ((string= interface "xdg_wm_base")
           (setf (xdg-wm-base window) (wl:registry-bind registry id wl:xdg-wm-base-interface 1))
